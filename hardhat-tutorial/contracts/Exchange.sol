...
contract Exchange is ERC20 {
    ...
    */
    function addLiquidity(uint _amount) public payable returns(uint) {
        ...
        */
        ...
        // is adding `Eth` to the contract, so whatever `Eth` contract has is equal to the one
        // supplied
        ...
        // _mint is ERC20.sol smart contract function to mint ERC20 tokens
            ...
            liquidity
            */
            // EthReserve should be the current ethBalance subtracted by the value of ether 
            // sent by the user
    ...
    */
    function removeLiquidity(uint _amount) public returns(uint, uint) {
        ...
        // = (current Eth reserve * amount of LP tokens that user wants to withdraw) / 
        ...
        // = (current Crypto Dev token reserve * amount of LP tokens that user wants to withdraw) 
        // (total supply of LP tokens)
        ...
        // Transfer `cryptoDevTokenAmount` of Crypto Dev tokens from the user's wallet to 
        // the contract
